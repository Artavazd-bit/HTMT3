...
write.csv2(simnormal, "Normalsim05.csv")
write.csv2(simnormal2, "Normalsimag05.csv")
...
write.csv2(simnonnormal, "nonnormalsim05.csv")
write.csv2(simnonnormal2, "nonnormalsimag05.csv")
