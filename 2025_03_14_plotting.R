...
ggplot(sim_overview_com, aes(n, RR_09)) + geom_line(aes(linetype = as.factor(sim_overview_com$Method))) + geom_point() + 
  facet_grid(cols = vars(loading_com), rows = vars(correlation)) + theme(legend.position="none")
